...
import com.merchant.utils.UriUtil;
 ...
 * version: 1.0
 */
public class ScanBankCardActivity extends BaseActivity implements Callback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scanbankcard);
        //ViewUtil.addTopView(getApplicationContext(), this, R.string.scan_card);
        CameraManager.init(getApplication());
        viewfinderView = (ViewfinderView) findViewById(R.id.viewfinder_content);
        HeaderViewControler.setHeaderView(this, "扫描银行卡", null);
        UIUtil.setColor(this, getResources().getColor(R.color.black));

        back = findViewById(HeaderViewControler.ID);
...
//		cancelScanButton = (Button) this.findViewById(R.id.btn_cancel_scan);
    ...
    private void handleAlbumPic(Intent data) {
        //获取选中图片的路径
        photo_path = UriUtil.getRealPathFromUri(ScanBankCardActivity.this, data.getData());

        mProgress = new ProgressDialog(ScanBankCardActivity.this);
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (result != null) {
                    ...
                    ScanBankCardActivity.this.setResult(RESULT_OK, resultIntent);
                    finish();
                } else {
                    Toast.makeText(ScanBankCardActivity.this, "识别失败", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
...
//		});
    ...
    public void handleDecode(Result result, Bitmap barcode) {
        ...
        if (TextUtils.isEmpty(resultString)) {
            Toast.makeText(ScanBankCardActivity.this, "Scan failed!", Toast.LENGTH_SHORT).show();
        } else {
            Intent resultIntent = new Intent();
            Bundle bundle = new Bundle();
    ...
    private View.OnClickListener flashListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            try {
                ...
                if (!isSuccess) {
                    Toast.makeText(ScanBankCardActivity.this, "暂时无法开启闪光灯", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (isFlashOn) {
                    // 关闭闪光灯
                    btnFlash.setImageResource(R.mipmap.scan_hightlight_img);
                    isFlashOn = false;
                } else {
                    // 开启闪光灯
                    btnFlash.setImageResource(R.mipmap.scan_hightlight_img);
