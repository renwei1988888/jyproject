...
/**
 * @name renwei
 * @time 2018/9/20 21:42
 * @class 营业分析
 */
public class BusinessAnlysisActivity extends BaseActivity implements View.OnClickListener {

    private LinearLayout top_ll, title_ll;
    private LineChartView lineChartView, year_lineChartView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_businessanalysis);
        findViewAndInit();
    }

    private void findViewAndInit() {
        HeaderViewControler.setHeaderView(this, "营业分析", this);
